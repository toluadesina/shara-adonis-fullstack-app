...
gulp.task('watch', function(){
    gulp.watch(paths.stylePath + '**/*.scss', gulp.parallel('styles'));
    gulp.watch(paths.jsPath + '**/*.js', gulp.parallel('custom-js'));
})

gulp.task('default', gulp.series('watch', 'vendor-js', 'styles', 'custom-js', 'move-icons'))
